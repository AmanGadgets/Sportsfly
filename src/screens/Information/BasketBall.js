      ...
      <View style={{ flex: 1 }}>
        <View style={{ marginBottom: 50 }}>
          <ScrollView>
            ...
            <Text style={{ fontSize: 20, fontFamily: "RobotoSlab_600SemiBold", textAlign: "justify",marginLeft: 15,marginRight:15 }}>Basketball is a team sport in which two teams, most commonly of five players each, opposing one another on a rectangular court,
              ...
              (a basket 18 inches (46 cm) in diameter mounted 10 feet (3.048 m) high to a backboard at each end of the court,
              while preventing the opposing team from shooting through their own hoop. A field goal is worth two points, unless made from behind the three-point line,
              when it is worth three. After a foul, timed play stops and the player fouled or designated to shoot a technical foul is given one, two or three one-point free throws.
            ...
            <View style={{ height: 500 }}>
              <ImageBackground style={{ height: 350, width: 420, marginLeft: 5, marginTop: 10, borderRadius: 10}} source={require("../../../assets/basketball2.jpg")}>
              </ImageBackground>
            </View>
            ...
            <View>
                ...
                <Text style={{marginLeft: 10,fontSize: 20,  fontFamily:"RobotoSlab_700Bold",marginBottom:10,marginTop: -100, textAlign: "center" }}>
                  The Rules
                </Text>
                ...
                <View style={{ height: 250 }}>
              <ImageBackground style={{ height: "90%", width: 400, marginLeft: 10, marginTop: 20, borderRadius: 10, marginBottom: -50 }} source={require("../../../assets/basketballclock.jpg")}>
              </ImageBackground>
            </View>
                ...
                <View>
                  ...
                  <View style={{ height: 250 }}>
              <ImageBackground style={{ height: "90%", width: 400, marginLeft: 10, marginTop: 20, borderRadius: 10, marginBottom: -50 }} source={require("../../../assets/basketball_court.gif")}>
              </ImageBackground>
            </View>
                </View>
